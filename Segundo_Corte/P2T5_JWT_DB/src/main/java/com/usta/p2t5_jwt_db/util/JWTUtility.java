package com.usta.p2t5_jwt_db.util;
...
public class JWTUtility implements Serializable {
    ...
    /**
     * The function getUsernameFromToken() takes a token as a parameter and returns
     * the username from
     * the token
     * 
    ...
    /**
     * The function getClaimFromToken() is called with the token and a lambda
    ...
    /**
     * It takes a token and a function as input and returns the result of applying
     * the function to the
     * claims of the token
     * 
     * @param token          The JWT token
     ...
     * 
     * @param userDetails This is the user object that contains the user
     *                    information.
     * @return A token
     */
    ...
    /**
     * If the username in the token matches the username in the userDetails object
     * and the token is not
     * expired, then return true
     * 
     * @param token       The JWT token to validate
     * @param userDetails The user details object that contains the username and
